package com.example.android.camerax.tflite.helper;// Heavily based on RabbitMQ MQTT adapter test case code!
...
public class UpdateWeight implements MqttCallback {
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        ...
        String path = "src/main/assets/saved_file.txt";
...
//
        ...
        System.out.println("INside updateWeightSJSJ !!..");
        String path = "src/main/assets/saved_file.txt";
        File file = new File(path);
        try (FileOutputStream fos = new FileOutputStream(file)) {
            System.out.println("INside  TRy updateWeightSJSJ !!..");
            fos.write("Hi We are testing....  :)".getBytes());

            //fos.close // no need, try-with-resources auto close
        } catch (IOException e) {
            System.out.println("INside  Catch updateWeightSJSJ !!..");
            e.printStackTrace();
        }
    }
...
/*
    public static void main(String[] args) {
        UpdateWeight mqt = new UpdateWeight();
        mqt.run();
    }
